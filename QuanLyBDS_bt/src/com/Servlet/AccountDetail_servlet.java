...
public class AccountDetail_servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/AccountDetail.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	           ...
	           String fullSavePath = "D:\\Pro\\JavaOne\\Test_Upload_Images\\WebContent\\images\\users" + File.separator + "id"+"01";
